		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="mb-3">
					...
					<input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" placeholder="User Email">
					@error('email')
					<div class="alert alert-danger">{{ $message }}</div>
					@enderror
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control @error('country') is-invalid @enderror" name="country" id="country" value="{{ old('country') }}"  placeholder="From where">
					@error('country')
					<div class="alert alert-danger">{{ $message }}</div>
					@enderror
